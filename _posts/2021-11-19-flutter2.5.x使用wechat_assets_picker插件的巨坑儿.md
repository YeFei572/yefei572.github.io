...
tags: Git
categories: 个人笔记
title:  "flutter2.5.x使用wechat_assets_picker插件的巨坑儿!"
---

> 这个插件限制太多了，一会这一会那，对开发者非常不友好，各种刁难。不建议使用
...
### 五、没事别用这个组件。麻烦的一批！
替代的产品多的是，`image_picker`、`multi_image_picker2`等等
